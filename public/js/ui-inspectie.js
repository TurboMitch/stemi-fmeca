...
const FIELDS = [
  ...
  ['conditie','NEN 2767 conditie',['conditie','conditiescore','score','cs']],['ontwikkeling','Ontwikkeling / observatie',['ontwikkeling','observatie','trend']],['inspecteerbaarheid','Inspecteerbaarheid',['inspecteerbaar','toegankelijk','zichtbaar']],['bewijs','Foto / bewijs',['foto','bewijs','referentie','afbeelding']],
...
function render() {
  ...
  const cols = [['object','Object'],['element','Element'],['locatie','Locatie'],['constatering','Constatering','wrap'],['gebrek','NEN gebrek','wrap'],['ernst','Ernst','sel',C.ERNST],['intensiteit','Intensiteit','sel',C.INTENSITEIT],['hoevTotaal','Totaal','n'],['eenheid','Eenh.'],['hoevGebrek','Met gebrek','n'],['conditie','Conditie','n'],['inspecteerbaarheid','Inspecteerbaar','sel',C.INSPECTEERBAAR],['onderzoek','Onderzoek?','sel',['','Ja','Nee']],['toelichting','Toelichting inspecteur','wrap'],['maatregel','Std. maatregel','wrap'],['kengetal','€/eenheid','n'],['omslagMaatregel','Omslag% maatregel','n'],['nenCode','NEN code']];
  el.innerHTML = `
