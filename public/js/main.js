...
const R = { projecten: () => U.renderProjecten(), overzicht: () => U.renderOverzicht(), eigenaar: () => U.renderEigenaar(), inspectie: () => U.renderInspectie(), specialist: () => U.renderSpecialist(), systeem: () => U.renderSysteem(), mjop: () => U.renderMjop(), instellingen: () => U.renderInstellingen(), uitleg: () => U.renderUitleg() };
